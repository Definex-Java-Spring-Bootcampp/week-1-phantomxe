...
public class OrderService {
    ...
    public Customer getCustomer(String name, String email) throws Exception {
        Optional<Customer> customer = customers.stream().filter(c -> c.getName().equals(name) && c.getEmail().equals(email)).findFirst();
